...
export function CertificatePage() {
  return (
    <ConsumerShell title="Giấy khai sinh số" subtitle="Certificate mock cho hộp bánh gai đã xác thực.">
      <section className="rounded-lg border border-gold bg-[#FCF6EC] p-6 shadow-sm">
        <p className="text-xs font-semibold uppercase tracking-[0.12em] text-[#8A6238]">Certificate</p>
        <h2 className="mt-2 text-2xl font-bold">{banhGaiConsumerData.product.certificate}</h2>
        <p className="mt-4 leading-7 text-[#4A2D1E]">Hộp bánh gai thuộc lô {banhGaiConsumerData.product.batch}, được xác nhận trong hệ thống truy xuất nguồn gốc nội bộ của Thành Nam hương ký.</p>
